...
const (
	...
	RESPMSG_ERRORUSERCOUNT = "ERROR_USERCOUNT"
...
var recodeText = map[string]string{
	...
	//用户
	RESPMSG_SUCCESSLOGIN:    "用户登陆成功",
	RESPMSG_FAILURELOGIN:    "用户账号或密码错误，登陆失败",
	RESPMSG_SUCCESSSESSION:  "获取用户信息成功",
	RESPMSG_ERRORSESSION:    "获取用户信息失败",
	RESPMSG_HASNOACCESS:     "亲，您的权限不足",
	RESPMSG_SIGNOUT:         "退出成功",
	RESPMSG_ERRORUSERCOUNT: "获取用户总数失败",
